...
using MarketAlly.Maui.ViewEngine.Platforms.Android.Common;
using Microsoft.Maui.Handlers;
using Android.Widget;
using Android.Views;
using MarketAlly.Maui.ViewEngine.Events;
using MarketAlly.Maui.ViewEngine.Helpers;

namespace MarketAlly.Maui.ViewEngine.Platforms.Android
{
